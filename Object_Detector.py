...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.image.setGeometry(QtCore.QRect(200, 0, 411, 351))
        self.image.setObjectName("image")

        self.image2 = QtWidgets.QLabel(self.centralwidget)
        self.image2.setGeometry(QtCore.QRect(200, 350, 411, 351))
        ...
        self.ObjectsList = {}
        self.pixmap = QPixmap()
        self.decode, self.encode = EncodeDecodeLabels()
        self.output_dict = {}
	#print(self.decode)
        #### encode <=> name -> number
        #### decode <=> number -> name
        for object in self.encode:
            self.ObjectsList[object] = 1
            print(object)
    ...
    def clickBox(self, b):
        self.ObjectsList[b.text()] = 1 - self.ObjectsList[b.text()]
    ...
    def RunTheCode(self):
        ...
        if detection_score == 0:
            detection_score = .5
        image_path, self.output_dict = ModelInference.RunInference(self.path, self.ObjectsList, detection_score=detection_score)
        height_label = 300
        width_label = 300
        #self.image2.resize(width_label, height_label)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.r1.setText(_translate("MainWindow", "SSDLiteMOBILENET"))  
