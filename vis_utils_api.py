...
"""
# THIS VERSION HAS objects_list as a list not dict
...
def visualize_boxes_and_labels_on_image_array_improved(
    image,
    objects_list,
    boxes,
    classes,
  ...
  # Draw all boxes onto image.
  for box, color in box_to_color_map.items():
    string = box_to_display_str_map[box][0].split(":")[0]
    if string not in objects_list:
      continue
